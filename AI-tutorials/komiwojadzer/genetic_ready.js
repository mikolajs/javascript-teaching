...
function main() {
  for (const nr of arr) {
    ...
    console.log('time evolution %d, time survive %d, mutations %d',
      timers.getTime(1), timers.getTime(2), timers.getTime(3));
...
function _reverseGene(ant){
  ...
  ant.gene = ant.gene.slice(splitSize, this.gene.length-1)
